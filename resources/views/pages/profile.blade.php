            ...
            <div class="row">
              ...
              <div class="col m3">
                <div class="card-panel teal lighten-1 hide-on-med-and-down">
                  ...
                  @hasrole('Admin')  Admin. <br>So, you have all of the privileges relating to documents, users, departments, and etc. Moreover, you can assign roles and permssions and can see users' activities. @endhasrole
                  @hasrole('Moderator')  Moderator. <br>So, you can manage users in your department, upload documents and edit/share/remove them. You can see your activity log but cannot clear them. @endhasrole
