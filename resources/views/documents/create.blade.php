...
<div class="row">
  <div class="section">
    ...
    {{Breadcrumbs::render('createdocuments')}}      
      <div class="row">
        <h5 class="flow-text"><i class="material-icons">folder</i> Upload Document
          ...
          <div class="card hoverable">
            <div class="card-content">
              ...
              <div class="input-field">
                ...
                {{ Form::text('url', '', ['class' => 'validate', 'id' => 'url']) }}
              ...
              <div class="row">
                ...
                <div class="col s4 input-field further_child">
                    <i class="material-icons prefix">class</i>
                    <select name="further_child_id"></select>
            ...
            if (stateID) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="further_child_id"]').append('<option value="">Select Sub Category Item</option>');
                        $.each(data, function(key, value) {
